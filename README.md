...
- Иконки статуса для workspace, к которым аккаунт не подключён, и для деактивированных workspace.
...
- `Инфо`: открыть информацию по текущему workspace.
